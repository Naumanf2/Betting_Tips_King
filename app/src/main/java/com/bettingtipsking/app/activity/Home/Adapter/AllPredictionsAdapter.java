package com.bettingtipsking.app.activity.Home.Adapter;
...
public class AllPredictionsAdapter extends RecyclerView.Adapter<AllPredictionsAdapter.ViewHolder> {
    Context context;
    ...
    public AllPredictionsAdapter(HomeFragment homeFragment,Context context, List<AllPredictionsModel> list, PredictionsInterface predictionsInterface) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AllPredictionsAdapter.ViewHolder(view);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        CardView cardview, subscription_cv;
