...
public class FinalMatchDetailsModel implements Parcelable {
    private int fixtureId;
    private String fixtureReferee;
    private String fixtureTimezone;
    private String fixtureDate;
    private String fixtureTimestamp;
    private String fixturePeriodsFirst;
    private String fixturePeriodsSecond;
    private String fixtureVenueId;
    ...
    private String fixtureStatusElapsed;
    ...
    protected FinalMatchDetailsModel(Parcel in) {
    ...
    public static final Creator<FinalMatchDetailsModel> CREATOR = new Creator<FinalMatchDetailsModel>() {
        @Override
        public FinalMatchDetailsModel createFromParcel(Parcel in) {
            return new FinalMatchDetailsModel(in);
        }

        @Override
        public FinalMatchDetailsModel[] newArray(int size) {
            return new FinalMatchDetailsModel[size];
        }
    };
