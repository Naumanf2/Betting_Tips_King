...
import com.bettingtipsking.app.databinding.FragmentPastFixturesBinding;
...
public class PastFixturesFragment extends Fragment implements ItemClickListener, DatePickerDialog.OnDateSetListener {

    FragmentPastFixturesBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentPastFixturesBinding.inflate(inflater, container, false);
        viewModel = new ViewModelProvider(this, new PastFixturesViewModelFactory(FixturesRetrofitHelper.INSTANCE.getInstance().create(FixturesService.class))).get(PastFixturesViewModel.class);
        ...
        binding.textEreyesterday.setOnClickListener(v -> {
            viewModel.getPastFixtures(getEreyesterday(getTodayDate()));
        });
