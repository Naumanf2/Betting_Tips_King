...
@Database(entities = {Predictions.class, PendingPredictions.class, FavouritLeaguesEntity.class, MatchesNotificationEntity.class}, version = 2)
public abstract class MyLocalDatabase extends RoomDatabase {
    ...
    public abstract MatchesNotificationDao matchesNotificationDao();
