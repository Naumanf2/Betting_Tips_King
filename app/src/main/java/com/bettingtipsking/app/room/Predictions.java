...
public class Predictions {
    ...
    public Predictions(int id, String status, String sort, String owner, String created_on, String modified_on, String league_name, String match_id, String home_team, String away_team, String odd_value, String team_home_score, String team_away_score, String match_minute, String coupon_name, String game_prediction, String match_date, String match_status, String match_time, String match_timestamp, String sport_type) {
        this.id = id;
        this.status = status;
        this.sort = sort;
        this.owner = owner;
